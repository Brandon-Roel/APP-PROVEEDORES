// Configuración de la aplicación para Compras
class AppCompras {
    constructor() {
        this.userName = 'Rosario Shadani Martinez Galvez';
    ...
    init() {
        document.addEventListener('DOMContentLoaded', () => {
            console.log('🚀 Aplicación de Compras inicializada');
    ...
    showWelcomeScreen() {
        ...
        welcomeMessage.textContent = `Bienvenida`;
        personalWelcomeTitle.textContent = `¡Bienvenida ${this.userName}!`;
    ...
    setupMainNavigation() {
        ...
        document.getElementById('btnVisualizarSolicitudesMain').addEventListener('click', () => {
            this.showPanel('visualizar-solicitudes');
            this.updateSidebarActive('visualizar-solicitudes');
        });
        ...
        document.getElementById('btnVolverInicioVisualizar').addEventListener('click', () => {
            this.showPanel('inicio');
            this.updateSidebarActive('inicio');
        });
    ...
    showPanel(panelName) {
        ...
        document.getElementById('visualizarSolicitudesPanel').style.display = 'none';
        ...
        switch (panelName) {
            ...
            case 'visualizar-solicitudes':
                document.getElementById('visualizarSolicitudesPanel').style.display = 'block';
                // Cargar solicitudes para compras
                if (typeof cargarSolicitudesCompras === 'function') {
...
// Inicializar la aplicación de compras
const appCompras = new AppCompras();